...
<div id="cabeza">
	...
	or die("<h2>Problemas al conectar con el servidor</h2>");
					       ...
					       mysqli_query($conexion, "update docente set asignatura='$_REQUEST[asignaturanonuevo]' where asignatura='$_REQUEST[asignaturaviejo]'") or die("Problemas en el select:".mysqli_error($conexion));
       		?>
    </div><br><br>
